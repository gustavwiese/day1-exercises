      ...
      <div className="outer-div-style">
        ...
        <div style={{ display: "flex" }}>
          ...
          <div className="exercise-style">
            ...
            {selectedView == "state2" ? <StateDemo2 title="State exercise" /> : null}
            {selectedView == "state3" ? <StateDemo3 title="State exercise" /> : null}
            {selectedView == "useEffect" ? <UseEffectDemo title="UseEffect exercise" /> : null}
